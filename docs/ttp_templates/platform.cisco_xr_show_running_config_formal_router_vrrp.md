Reference path:
```
ttp://platform/cisco_xr_show_running_config_formal_router_vrrp.txt
```
...
```
<template name="cisco_xr_vrrp" results="per_template">
<doc>
Template to parse and normalize Cisco IOS-XR VRRP formal configuration.
...
def transform_vrrp_to_records(data):
    from ttp_templates.utils.cisco_xr_process_show_running_config_formal_router_vrrp import transform_vrrp_config
