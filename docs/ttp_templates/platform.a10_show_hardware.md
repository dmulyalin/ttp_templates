...
<group>
Thunder Series Unified Application Service Gateway {{ module | let("description", "Thunder Series Unified Application Service Gateway") | _start_ }}
AX Series Advanced Traffic Manager {{ module | let("description", "AX Series Advanced Traffic Manager") | _start_ }}
