...
Vlan ID: - not advertised   
    ...
    assert res == [{'opencondig-lldp': {'lldp': {'config': {'system-name': 'switch1'},
                                          'interfaces': {'interface': [{'name': '10GE2/1/23',
                                                                        'neighbors': {'neighbor': [{'id': 1,
                                                                                                    'state': {'capabilities': {'capability': [{'name': 'MAC_BRIDGE'}, {'name': 'ROUTER'}]},
                                                                        ...
                                                                        'neighbors': {'neighbor': [{'id': 1,
                                                                                                    'state': {'capabilities': {'capability': [{'name': 'MAC_BRIDGE'}, {'name': 'ROUTER'}]},
                                                                                                              ...
                                                                                                              'system-description': 'Cisco IOS Software, C4321 Software (C4321-IPBASEK9-M), Version 143.0(2)SE7, '
                                                                                                                                    ...
                                                                                                                                    'by prod_rel_team',
                                                                                                              'system-name': 'r5.lab.local'}}]}}]}}}},
            {'opencondig-lldp': {'lldp': {'config': {'system-name': 'switch333'},
                                          'interfaces': {'interface': [{'name': '10GE2/1/121',
                                                                        'neighbors': {'neighbor': [{'id': 1,
                                                                                                    'state': {'capabilities': {'capability': [{'name': 'MAC_BRIDGE'}, {'name': 'ROUTER'}]},
...
Peer MAC Address: 66:33:88:65:11:44
    ...
    res = parser.result(structure="flat_list")
    # pprint.pprint(res, width=200)    
    assert res == [{'opencondig-lldp': {'lldp': {'config': {'system-name': 'xr-route-1'},
                                                 'interfaces': {'interface': [{'name': '10GE0/0/0/0',
                                                                               'neighbors': {'neighbor': [{'id': 1,
                                                                                                           'state': {'capabilities': {'capability': [{'name': 'MAC_BRIDGE'}, {'name': 'ROUTER'}]},
                                                                              ...
                                                                              {'name': '100GE0/0/2/0',
                                                                               'neighbors': {'neighbor': [{'id': 1,
                                                                                                           'state': {'capabilities': {'capability': [{'name': 'ROUTER'}]},
                                                                                                                     ...
                                                                                                                     'system-name': 'edge-route-1'}}]}}]}}}},
                   {'opencondig-lldp': {'lldp': {'config': {'system-name': 'xr-route-0'},
                                                 'interfaces': {'interface': [{'name': '10GE0/0/0/1',
                                                                               'neighbors': {'neighbor': [{'id': 1,
                                                                                                           'state': {'capabilities': {'capability': [{'name': 'MAC_BRIDGE'}, {'name': 'ROUTER'}]},
                                                                                                                     'chassis-id': '12:34:12:34:12:34',
                                                                                                                     'chassis-id-type': 'MAC_ADDRESS',
...
Vlan ID: not advertised
    ...
    res = parser.result(structure="flat_list")
    # pprint.pprint(res, width=200)
    assert res == [{'opencondig-lldp': {'lldp': {'config': {'system-name': 'switch-nxos-core-1'},
                                                                              ...
                                                                              {'name': 'Eth1/21',
                                                                               'neighbors': {'neighbor': [{'id': 1,
                                                                                                           'state': {'capabilities': {'capability': []},
                                                                                                                     ...
                                                                                                                     'system-description': 'null',
                                                                                                                     'system-name': 'null'}}]}}]}}}},
                   {'opencondig-lldp': {'lldp': {'config': {'system-name': 'switch24-edge-1'},
                                                 'interfaces': {'interface': [{'name': 'Eth5/3',
                                                                               'neighbors': {'neighbor': [{'id': 1,
                                                                                                           'state': {'capabilities': {'capability': [{'name': 'MAC_BRIDGE'}, {'name': 'ROUTER'}]},
